            ...
            <div className='lg:mx-auto  lg:w-10/12 w-full lg:p-0 p-2 lg:space-y-24 lg:mt-24'>
                <div className='flex lg:flex-row flex-col lg:space-y-0 space-y-5  justify-center items-center'>
                    <div className='lg:w-1/3 flex flex-col space-y-6 lg:space-y-16'>
                        <h1 className='font-serif lg:leading-snug font-bold lg:text-5xl text-4xl lg:text-start text-center'><FormattedMessage id='menuFall' /></h1>
                        <p className='lg:text-2xl text-[16px] leading-8 lg:leading-10 font-roboto'><FormattedMessage id='bigLorem' /> </p>
                    </div>
                ...
                <div className='flex lg:flex-row-reverse  flex-col lg:space-y-0 space-y-5  justify-center items-center'>
                    <div className='lg:w-1/3  flex flex-col space-y-6 lg:space-y-16'>
                        <h1 className='font-serif lg:leading-snug font-bold lg:text-5xl text-4xl lg:text-start text-center'><FormattedMessage id='frenchFries' /></h1>
                        <p className='lg:text-2xl text-[16px] leading-8 lg:leading-10 font-roboto'><FormattedMessage id='bigLorem' /> </p>
                    </div>
